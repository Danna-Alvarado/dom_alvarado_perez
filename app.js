...
const nombre_alumno ="Soy Danna Alvarado, mi programa termino a las: ";
...
btnGenerar.addEventListener('click', () => {
    ...
    if (correo === "" || !correo.includes('@')) {
        ...
        console.error("No pusiste el correo electronico valido")
        return;
    }
    ...
    console.log("El token ha sido correcto");
